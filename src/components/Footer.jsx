          ...
          <div className="col-start-1 row-start-1 grid grid-cols-12 pt-14 pb-6 relative z-20 lg:py-10 px-4 md:px-7 gap-x-3 md:gap-x-5 gap-y-3 md:gap-y-7">
            ...
            <div className="flex flex-col items-start justify-start col-span-12 mb-10 lg:mb-0 lg:col-span-4 gap-y-3 md:gap-y-5">
              ...
              <div className="w-full relative">
                <input
                  ...
                  className="appearance-none transition bg-grey-400 rounded-full w-full text-white font-medium tracking-tight leading-none text-lg px-5 py-4 lg:text-xl lg:px-6 lg:py-5 placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-white/15"
                />
              ...
              <div className="flex gap-1 flex-wrap">
                {[
                  ...
                  <a key={s.href} href={s.href} target="_blank" rel="noreferrer"
                    className="inline-flex items-center gap-x-2.5 rounded-xl text-xs px-2 py-1 transition pointer-fine:hover:rounded-sm bg-white text-grey-900">
                    <i className={s.icon} />
                    <i className="fa-regular fa-sharp fa-arrow-up-right" />
                  </a>
                ))}
            ...
            <div className="flex justify-between col-span-12 flex-wrap md:flex-row md:col-span-11 lg:col-span-6 lg:col-start-6 gap-y-10">
              {[
                ...
                <div key={ci} className="flex flex-col items-start gap-y-1.5 border-l border-white/20 pl-3 w-1/2 md:w-auto">
                  {col.map(link => (
