...
const BG_IMAGES = [
  '/images/headerSection/bg/unnamed-6.webp',
  '/images/headerSection/bg/RedBull-Instagram-Post-45.webp',
  '/images/headerSection/bg/Emirates-airpline-in-flight.webp',
  '/images/headerSection/bg/Pooky-Rechargable-Doorstop-Cordless-100-Straight-Empire-Pendant-Silk-Ikat-Shade-in-Black-and-Cream-Atlas-44-Single-chukka-Cordless-95-scaled-1-1.webp',
  '/images/headerSection/bg/Screenshot-2025-07-01-at-21.36.35.webp',
  '/images/headerSection/bg/spaseekers.webp',
];

const LeafSVGLeft = () => (
  <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 fill-current text-white">
          ...
          <div className="w-full h-full overflow-hidden grid bg-grey-900 rounded-3xl scale-105">
            ...
            <div className="col-start-1 row-start-1 z-20 relative flex justify-center items-center bg-grey-900/30">
              <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col items-center justify-center mb-5">
                  ...
                  <div className="flex items-center gap-x-2">
                    ...
                    <div className="w-12 aspect-20/9 relative">
                      <img src="/images/headerSection/logo/global-search-awards.webp" alt="Global Search Awards" className="w-full h-full object-contain absolute inset-0" />
                    </div>
                    <div className="w-12 aspect-20/9 relative">
                      <img src="/images/headerSection/logo/Mask-group.webp" alt="" className="w-full h-full object-contain absolute inset-0" />
                    </div>
                    <div className="w-12 aspect-20/9 relative">
                      <img src="/images/headerSection/logo/UKSocial-Media-Awards-White.webp" alt="UK Social Media Awards" className="w-full h-full object-contain absolute inset-0" />
                    </div>
                ...
                {/* Platform logos row — only at 3xl+ */}
                <div className="w-full hidden 3xl:flex justify-center relative overflow-hidden z-0 mt-12 gap-x-14 items-center">
                  {[
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Google-Logo.png?w=400&q=80&fm=webp', alt: 'Google' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/ChatGPT-Logo.png?w=400&q=80&fm=webp', alt: 'ChatGPT' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Gemini-Logo.png?w=400&q=80&fm=webp', alt: 'Gemini' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/TikTok-Logo.png?w=400&q=80&fm=webp', alt: 'TikTok' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/YouTube-Logo.png?w=400&q=80&fm=webp', alt: 'YouTube' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Pinterest-Logo.png?w=400&q=80&fm=webp', alt: 'Pinterest' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Giphy-Logo.png?w=400&q=80&fm=webp', alt: 'Giphy' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Reddit-Logo.png?w=400&q=80&fm=webp', alt: 'Reddit' },
                    { src: 'https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Amazon-Logo.png?w=400&q=80&fm=webp', alt: 'Amazon' },
                  ].map((logo) => (
                    <img key={logo.alt} src={logo.src} alt={logo.alt} className="h-6 object-contain" loading="lazy" />
                  ))}
                </div>
